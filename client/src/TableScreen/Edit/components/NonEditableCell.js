export default function NonEditableCell({ value, rowIndex, columnIndex, color }) {
    ...
    return (
        <td
            ...
            className={`cell100 ${(columnIndex == 0  || columnIndex == undefined)? 'first-columns' : 'last-columns'} ${color}`}
