...
const UploadFile = ({ fileState, onFileAdded, onFileDelete }) => {
    // Destructure the file-related state
    const { file, isFileAdded } = fileState;
        ...
        <>
            <div className="container">
                <div className="d-flex justify-content-between mb-3 top-buttons">
                    ...
                    <h2 className="justify-content-center col-4">Pick a CSV file to upload:</h2>
                    <div className="col-4"></div>
                </div>
            </div>
            <div className="container-fluid py-3">
                <div className="d-flex justify-content-between mb-3">
                    ...
                    {!isFileAdded && <div id="inform" className="container col-4">
                        <form id="file-upload-form" className="uploader">
                            <input id="file-upload" type="file" name="fileUpload" accept=".csv" onChange={handleFileAdded} />
                            <label style={{ height: "fit-content" }} for="file-upload" id="file-drag">
            ...
            {isFileAdded && (
                <div className="d-flex justify-content-between mb-3 top-buttons">
                    ...
                    <span class="badge badge-primary">
                        {file.name}
                        <button type="button" class="close" aria-label="Dismiss" onClick={handleFileDelete}>
